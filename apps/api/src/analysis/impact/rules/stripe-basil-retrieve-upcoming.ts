 ...
 * not paraphrased from third-party summaries or invented:
 *
 ...
 */
export const STRIPE_BASIL_RETRIEVE_UPCOMING_RULE: RuleDefinition = {
  providerChange: {
    provider: 'stripe',
  ...
  applicabilityConfig: {
    ...
    changeDescription: 'retrieveUpcoming was removed from the SDK',
  },
  runPredicate: (files) =>
